...
u16 sGoldenrodDepartment3F[] = {
    ITEM_LINKING_CORD, ITEM_FIRE_STONE,ITEM_THUNDER_STONE,ITEM_WATER_STONE, ITEM_LEAF_STONE, 
    ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_SHINY_STONE, ITEM_DAWN_STONE, ITEM_DUSK_STONE,
    ITEM_ICE_STONE, ITEM_RAZOR_FANG, ITEM_RAZOR_CLAW, ITEM_OVAL_STONE, ITEM_LEADERS_CREST,
    ITEM_METAL_COAT, ITEM_KINGS_ROCK, ITEM_DRAGON_SCALE, ITEM_UP_GRADE, ITEM_DEEP_SEA_SCALE,
    ITEM_DEEP_SEA_TOOTH, ITEM_ELECTIRIZER, ITEM_MAGMARIZER, ITEM_PROTECTOR, ITEM_DUBIOUS_DISC,
    ITEM_PRISM_SCALE, ITEM_REAPER_CLOTH, ITEM_SACHET, ITEM_WHIPPED_DREAM, ITEM_TART_APPLE,
    ITEM_SWEET_APPLE, ITEM_SYRUPY_APPLE, ITEM_CRACKED_POT, ITEM_CHIPPED_POT, ITEM_GALARICA_CUFF,
    ITEM_GALARICA_WREATH, ITEM_BLACK_AUGURITE, ITEM_UNREMARKABLE_TEACUP, ITEM_METAL_ALLOY, 0xFFFF
};
